...
<head>
    ...
    <link href="${request.getContextPath()}/resources/lib/Hui-iconfont/iconfont.css" rel="stylesheet" type="text/css" />
    <link href="${request.getContextPath()}/resources/css/H-ui.min.css" rel="stylesheet" type="text/css" />
    <link href="${request.getContextPath()}/resources/css/H-ui.admin.css" rel="stylesheet" type="text/css" />
    <title>404页面</title>
</head>
<body>
